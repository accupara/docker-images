...
/scratchbox/login fakeroot apt-get -y --force-yes install nokia-binaries nokia-apps libqt4-dev libqt4-experimental-dev libtelepathy-qt4-dev cli-common-dev
